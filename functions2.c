...
/**
 * print_non_printable - function to print ascii codes in hexa of non printable
...
/**
 * print_rot13string - function to Print a string in rot13 cipher.
 * @types: arg List of types
 * @buffer: arg Buffer array to handle print
 * @flags: arg to calculate active flags
 * @width: arg to get width
